...
public class NotificationMessageProvider {
    ...
    private static final Map<String, Map<NotificationType, String[]>> MESSAGE_TEMPLATES = Map.of(
            "KR", Map.ofEntries(
                    ...
                    Map.entry(NotificationType.COMMENT_MENTION, new String[]{"회원님을 부르고 있어요 📣", "%s님이 대화 중에 회원님을 찾으셨네요. 확인해 보세요!"}),
            ...
            "US", Map.ofEntries(
                    ...
                    Map.entry(NotificationType.COMMENT_MENTION, new String[]{"You were mentioned 📣", "%s mentioned you in a comment."}),
